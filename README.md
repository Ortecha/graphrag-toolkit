...
#### Additional Resources
  ...
  - [Vector and graph databases for Gen AI Agents](https://www.youtube.com/watch?v=qQeB2nuXNNo) [Video] Discussion on the differences between vector search and graph search, how they work, and how to use them together to enhance the accuracy of GenAI applications and more. Includes examples that use the GraphRAG Toolkit.
  - [Leveraging vector and graph databases: Enhancing Gen AI Applications with Hybrid Queries](https://medium.com/p/b3f691b586b2) [Blog Post] Companion blog post to the vector and graph databases video above.
